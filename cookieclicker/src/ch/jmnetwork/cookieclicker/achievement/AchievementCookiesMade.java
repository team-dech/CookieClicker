...
public class AchievementCookiesMade extends Achievement {
    ...
    public static String[] myDesc = new String[]{"Wake and bake", "Making some dough", "So baked right now", "Fledgling bakery", "Affluent bakery", "World famous bakery", "Cosmic bakery", "Galactic bakery", "Universal bakery", "Timeless bakery", "Infinite bakery", "Immortal bakery", "You can stop now", "Cookies all the way down", "Overdose", "How?"};
